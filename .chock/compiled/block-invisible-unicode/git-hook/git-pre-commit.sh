#!/usr/bin/env bash
# Auto-generated by chock compile. Declarative gate: block-invisible-unicode
set -eu
...
exec "$PY" "$repo_root/.chock/bin/gate.py" run \
  --gate "$repo_root/.chock/compiled/block-invisible-unicode/git-hook/gate.json" --event pre-commit
