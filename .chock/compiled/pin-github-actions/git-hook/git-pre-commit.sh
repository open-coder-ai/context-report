#!/usr/bin/env bash
# Auto-generated by chock compile. Declarative gate: pin-github-actions
set -eu
...
exec "$PY" "$repo_root/.chock/bin/gate.py" run \
  --gate "$repo_root/.chock/compiled/pin-github-actions/git-hook/gate.json" --event pre-commit
