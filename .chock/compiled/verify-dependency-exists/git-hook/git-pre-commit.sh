#!/usr/bin/env bash
# Auto-generated by chock compile. Declarative gate: verify-dependency-exists
set -eu
...
exec "$PY" "$repo_root/.chock/bin/gate.py" run \
  --gate "$repo_root/.chock/compiled/verify-dependency-exists/git-hook/gate.json" --event pre-commit
